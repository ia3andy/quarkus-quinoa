...
From here, copy your existing Web UI or generate an application from any existing Node based Web UI framework like <<react>>, <<angular>>, Lit, Webpack, Rollup, ... or your own. Example:
